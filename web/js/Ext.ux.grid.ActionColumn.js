...
Ext.ux.grid.ActionColumn = function(config)
{
...
Ext.extend(Ext.ux.grid.ActionColumn, Ext.util.Observable, {
  init : function(grid)
  {
//    this.grid = grid;
...
//
//      var styleSheet =
//        Ext.util.CSS.createStyleSheet('/* Ext.ux.form.ActionColumn stylesheet */\n' + styleBody, 'ActionColumn');
...
Ext.reg('ActionColumn', Ext.ux.grid.ActionColumn);