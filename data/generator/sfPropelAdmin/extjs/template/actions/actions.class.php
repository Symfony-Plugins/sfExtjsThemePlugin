...
<?php
  ...
  ob_start();
  require_once dirname(__FILE__).'/../lib/__BasesfPropelAdmin.class.php';
  $content = "[?php\n".ob_get_clean()."\n?]";
  ...
  // save template file
  $template = 'Base'.$this->getGeneratedModuleName().'.class.php';
  $this->getGeneratorManager()->getCache()->set($template, $this->getGeneratedModuleName().DIRECTORY_SEPARATOR.'lib', $retval);
?>
require_once dirname(__FILE__).'/../lib/<?php echo $template ?>';
class <?php echo $this->getGeneratedModuleName() ?>Actions extends <?php echo 'Base'.$this->getGeneratedModuleName() ?>Actions
{
<?php if($this->getParameterValue('ajax',true)): ?>
