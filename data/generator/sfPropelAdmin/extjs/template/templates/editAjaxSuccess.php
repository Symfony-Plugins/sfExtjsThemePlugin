...
[?php use_javascript(sfPJSHelper::pjs_path('<?php echo $this->getModuleName() ?>/editAjaxJs', false, array()), 'last'); //TODO: change sfPjsPlugin to accept first/last/none ?]
...
<?php if (sfConfig::get('app_sf_extjs_theme_plugin_module_returns_layout', true)):  ?>
    ...
    viewport.doLayout();
<?php else: ?>
    <?php echo sfConfig::get('app_sf_extjs_theme_plugin_module_panel_name', 'App.RequestedModulePanel') ?> = editPanel;
<?php endif; ?>
  });
